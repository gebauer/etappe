...
export const TAXONOMY = {
  ...
  canyon: { label: 'Canyon', dwell: 60, icon: 'canyon' },
  glacier: { label: 'Glacier', dwell: 90, icon: 'glacier' },
  hot_spring: { label: 'Hot spring', dwell: 120, icon: 'hot_spring' },
  volcano: { label: 'Volcano', dwell: 90, icon: 'volcano' },
  cave: { label: 'Cave', dwell: 60, icon: 'cave_entrance' },
  ...
  hike: { label: 'Hike', dwell: 180, icon: 'hiking' },
